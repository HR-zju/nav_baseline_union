...
```
save a rosbag that record the route
...
## run
```bash
python create_topomap_ros2.py --dt 1 --dir /home/mayukai/dev/code/visualnav-transformer/deployment/topomaps/images
python navigate_ros2.py --model <nomad/vint/gnm>
```
